...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        u1 = User( username = "Nicholas Martin", _password_hash = "1234567" )
        u2 = User( username = "Warren Zhang", _password_hash = "1234567" )
        u3 = User( username = "Yasmeen Yousef", _password_hash = "1234567" )
        u4 = User( username = fake.name(), _password_hash = "1234567" )
        u5 = User( username = fake.name(), _password_hash = "1234asdf" )
        users = [ u1, u2, u3, u4, u5 ]


        print( "Creating restaurants..." )
        res1 = Restaurant( name = "Pappy's STL BBQ", image = "iyuwe.jpg", address = fake.sentence(), user_id = 1 )
        res2 = Restaurant( name = "Hopdoddy Burger Bar", image = "owqeiur.jpg", address = fake.sentence(),user_id = 2 )
        res3 = Restaurant( name = "Adrianna's", image = "awetrwe.jpg", address = fake.sentence(), user_id = 3 )
        res4 = Restaurant( name = "Oyster House", image = "iowue.jpg", address = fake.sentence(), user_id = 4 )
        res5 = Restaurant( name = "Sugarfire", image = "awearf.jpg", address = fake.sentence(), user_id = 5 ) 
